...
const Info = () => {
    return (
        <div className="lg:pl-36 max-md:px-5 my-5 flex max-md:flex-col max-md:gap-7 justify-between items-center">
            <div>
                ...
                <img src="/images/preview.png" alt="" className="lg:w-4/5 w-[90%] max-md:mx-auto" />
            </div>
            <div className='flex flex-col gap-5 lg:items-start lg:w-[40%] max-md:items-center max-md:text-center max-md:text-sm'>
