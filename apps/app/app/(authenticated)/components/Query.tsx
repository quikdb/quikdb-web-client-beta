        ...
        <div className='flex flex-col items-center w-1/2'>
          <div className='grid gap-5 py-4 w-full'>
            <div className='grid gap-4'>
              ...
              <Input id='name' type='text' placeholder='Enter database name here' className='col-span-3' />
            </div>
            <div className='grid gap-4'>
              <Label htmlFor='capacity'>Choose Database</Label>
              <Select>
        ...
        <div className='w-1/2 flex flex-col gap-5'>
          ...
          <Card className='bg-transparent border-[#242527] text-white p-5'>
            <div className='flex justify-between items-center'>
              ...
              <Button className='bg-gradient w-fit px-4 text-[#0F1407]'>View</Button>
            </div>
