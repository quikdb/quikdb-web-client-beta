    ...
    <div className='mt-10 max-md:mt-5 flex flex-col gap-7'>
      ...
      <Card className='bg-[#151418] p-10 text-white text-center border-[#242527]'>
        <div className='flex flex-col items-center gap-2'>
          ...
          <p className='text-gradient font-medium text-3xl'>600</p>
          <p className='font-medium text-2xl'>Your reward points</p>
        </div>
        ...
        {rewards.map((reward, index) => (
          <Card key={index} className='bg-[#212024] w-[32%] text-white text-center border-[#242527] flex flex-col h-full'>
            ...
            <Card className='bg-[#151418] p-4 text-white text-center border-none w-full rounded-t-none h-full flex flex-col items-start gap-4'>
              ...
              <Button className='bg-transparent border border-[#242527] rounded-2xl w-full font-medium text-base text-gray-400 py-5'>
                Redeem
              </Button>
            </Card>
          </Card>
