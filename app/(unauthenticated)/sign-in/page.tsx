  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div className="flex flex-col w-full max-w-screen-2xl">
        <FormHeader
          title="Welcome back"
          description="Enter your email to sign in to this app"
          showLogo
        />
          ...
          <div className="flex flex-col w-full md:w-[680px] items-center">
            ...
            >
              ...
              <Link
                ...
                className="text-sm font-light text-right w-full pr-2 text-gradient"
              >
                Forgot Password?
              </Link>
            ...
            <section className="flex flex-col items-center gap-y-6">
              ...
              <p className="text-lg font-light text-[#B3B4B3]">
                ...
                <Link
                  href="/sign-up"
                  className="text-gradient hover:text-white font-medium"
                >
                  Sign up
                </Link>
              </p>
