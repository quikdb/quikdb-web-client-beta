...
const Info = () => {
    return (
        <div className="lg:pl-36 max-md:px-5 my-5 flex max-lg:flex-col max-md:gap-7 justify-between items-center">
            <div>
                <p className="text-3xl max-md:text-xl lg:ml-5 text-center font-medium mb-10 max-md:mb-5 lg:w-[65%]">Dashboard for tracking data.</p>
            ...
            <div className='flex flex-col gap-5 lg:items-start lg:w-[40%] max-lg:items-center max-lg:text-center max-md:text-sm'>
                <p className="text-[#858585] lg:w-[70%]">Track metrics, manage projects, and monitor databases—all in one place.</p>
